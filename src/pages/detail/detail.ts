 ...
 something = (function() {
  ...
  createTable(){
    this.sqlite.create({
      ...
      db.executeSql('CREATE TABLE IF NOT EXISTS Data(rowid INTEGER PRIMARY KEY ,name TEXT ,moisture TEXT,temperature TEXT, nameOne TEXT,nameTwo TEXT, TW TEXT, time TEXT )',{})
  ...
  insertData(){
    this.sqlite.create({
      ...
      this.arr[1],this.arr[2],this.arr[3],this.arr[4],this.arr[5],this.time])
      .then(res => {
